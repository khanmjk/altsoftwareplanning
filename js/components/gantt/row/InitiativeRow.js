...
class InitiativeRow {
  ...
  render(init, options = {}) {
    ...
    // Start Date Cell
    tr.appendChild(
      this._createDateCell(init, 'startDate', 'displayStart', hasWorkPackages, defaultStartDate)
    );

    // Target Date Cell
    tr.appendChild(
      this._createDateCell(init, 'targetDueDate', 'displayEnd', hasWorkPackages, null)
    );
  ...
  _createTitleCell(init, isExpanded) {
    ...
    cell.className =
      'gantt-table__cell gantt-table__cell--initiative gantt-table__cell--initiative-title';
  ...
  _createDependenciesCell(init, options) {
    const cell = document.createElement('td');
    cell.className =
      'gantt-table__cell gantt-table__cell--initiative gantt-table__cell--overflow-visible';
