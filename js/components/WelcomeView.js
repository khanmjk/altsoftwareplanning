...
class WelcomeView {
  ...
  render(container) {
    ...
    subtitle.textContent =
      'Your comprehensive, one-stop shop for Software Managers. Plan roadmaps, visualize architecture, forecast resources, and manage team capacity, all in one unified workspace.';
    ...
    const communityCard = this._createActionCard({
      title: 'Community Blueprints',
      description: 'Browse curated Top-100 blueprints and publish your own system templates.',
