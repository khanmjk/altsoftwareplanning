  ...
  renderAiTab(container) {
    ...
    const options = [
      ...
      { value: 'openai-gpt4o', text: 'OpenAI (GPT-4o) - Coming Soon', disabled: true },
      {
        ...
        text: 'Anthropic (Claude 3.5 Sonnet) - Coming Soon',
        disabled: true,
      },
    ];
    ...
    alertP.appendChild(
      document.createTextNode(
        ' Free-tier keys have rate limits. If you see "503 Model Overloaded", please wait a moment.'
      )
    );
  ...
  handleThemeApply(event) {
    ...
    if (currentDisplay) {
      ...
      currentDisplay.textContent =
        themeList.find((t) => t.id === selectedTheme)?.name || selectedTheme;
    }
