...
### 1. How are 'Effective Engineers', 'SDE-Weeks', and 'SDE-Days' calculated now?
...
### 2. Why is 'Effective Engineers' (Blue) lower than 'Total Ramped Up Engineers' (Green Dashed)?
...
### 3. How is the 'Est. Hires Required' calculated?
...
### 4. How does Attrition work in this model? What are its limitations?
...
### 5. How does Ramp-up Time work? What are its limitations?
...
### 6. How should I choose the manual input values (Hiring, Ramp-up, Attrition, Target Week)?
...
### 7. What are the key assumptions and limitations of this forecasting model?
...
### 8. What are potential future improvements for this forecasting model?
